...
public class UpdateQueryParser implements IParser {
    ...
    private String getRegex() {
        return RegexConstants.CASE_INSENSITIVE + RegexConstants.UPDATE + RegexConstants.SPACE + RegexConstants.TABLE_GROUP + RegexConstants.SPACE +
                RegexConstants.SET + RegexConstants.SPACE + RegexConstants.SET_VALUES + RegexConstants.SPACE_OPT +
