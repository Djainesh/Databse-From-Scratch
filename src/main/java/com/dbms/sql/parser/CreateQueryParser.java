...
public class CreateQueryParser extends OperationParser implements IParser {
  ...
  public String getRegex() {
    ...
    return RegexConstants.CASE_INSENSITIVE
        + RegexConstants.CREATE_KEYWORD
        + RegexConstants.SPACE
        + RegexConstants.CREATE_OPERATION
        + RegexConstants.SPACE
        + RegexConstants.MATCH_ALL
        + RegexConstants.END;
  }
  ...
  public String getCreateTableRegex() {
    ...
    return RegexConstants.CASE_INSENSITIVE
        + RegexConstants.CREATE
        + RegexConstants.SPACE
        + RegexConstants.TABLE_KEYWORD
        + RegexConstants.SPACE
        + RegexConstants.TABLE_GROUP
        + RegexConstants.SPACE_OPT
        + RegexConstants.CREATE_MATCH_ALL_COLUMNS
        + RegexConstants.SPACE_OPT
        + RegexConstants.END;
  }
